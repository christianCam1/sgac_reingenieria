 ...
 <!-- REQUIRED SCRIPTS -->
 <script src="<?php echo $URL;?>/app/controllers/login/cerrar_sesion.js"></script>
 <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAweO2Lp7TAy6Dx94kWAwnRoaZ_N1dQSDk&callback=initMap&libraries=places&v=weekly"></script>
 ...
 <script src="<?php echo $URL;?>/app/controllers/mapa/mostrar_mapa.js"></script>
 <script src="<?php echo $URL;?>/app/controllers/mapa/abrir_paseadores.js"></script>
