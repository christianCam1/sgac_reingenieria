                        ...
                        <div class="card-header">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item">
                                    ...
                                    <input type="text" id="uidBaja" name="email_user" hidden>
                                </li>
                                                ...
                                                <div class="col">
                                                    <div class="container">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <p style="font-size: medium;" id="emailbaja"> sin dato</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<script src="<?php echo $URL; ?>/app/controllers/users/bajaUsuarios.js"></script>
