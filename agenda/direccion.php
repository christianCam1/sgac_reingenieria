...
<script>
...

          {
            ...
            google.maps.event.addListener(pointMarker, 'click', (function (pointMarker, i) {
              return function () {
                ...
                infowindow.setContent(id + "," + d.nombre + ' <button class="btn btn-warning btn-sm" onclick="abrirPaseadores(\'' + id + '\')">Ver</button>' + ' <button class="btn btn-sm btn-danger" onclick="quitarCategoriaPerros(\'' + id + '\',\'' + i + '\')">Limpiar</button>');
    ...
    function abrirPaseadores(id) {
      ...
      window.open('../paseadores/index.php?uidPaseador=' + id, '_blank');
    }
