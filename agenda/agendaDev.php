                    ...
                    <div class="card card-outline card-primary">
                        ...
                        <div class="card-body" style="display: block;">
                            ...
                            <div class="container mt-3">
                                ...
                                <div class="d-flex mb-3">
                                    <div class="p-2 mr-auto "> 
                                        <button class="btn btn-secondary" id="cancelar"onclick="cancelar()">Cancelar</button> 
                                    </div>
                                    <div class="p-2 ">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-default"
                                                data-dismiss="modal">Cancelar</button>
                                            <button type="button" class="btn btn-primary"
                                                onclick="guardarCat()">Guasrdar</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="container mt-3">
                                <div class="d-flex mb-3">
                                    <div class="p-2 mr-auto "> 
                                        <button class="btn btn-secondary" id="cancelarAsignarPaseador" onclick="cancelarAsignarPaseador()">Cancelar</button> 
                                    </div>
                                    <div class="p-2 ">
                                        <button class="btn btn-primary" id="guardarAsignarPaseador" onclick="guardarAsignarPaseador()">Guardar</button>
                                    </div>
                                </div>
                            </div>
