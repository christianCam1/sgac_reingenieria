...
function logArrayElements(d, index, array) {
    ...
    if (d.validacion == "") {
        ...
        cell6.innerHTML = '<center><button class="btn btn-info" onclick="verpaseos(\'' + d.key + '\')">Validar</button></center>';

    } else {


        cell6.innerHTML = '<center><button class="btn btn-success disabled">Validado</button></center>';
    }
...
function verpaseos(key) {
    ...
    Swal.fire({
        title: '¿Deseas validar esta venta?',
        icon: 'question',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
        confirmButtonText: 'Si deseo validarla'
    }).then((result) => {
