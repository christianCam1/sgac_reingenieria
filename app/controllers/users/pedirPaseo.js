            ...
            ref.once("value", function (snapshot) {
                ...
                snapshot.forEach(function (data) {
                    ...
                    if (d.tipo == "basico") {
                        ...
                        console.log("Rukys (1): ", costoBasico)

                    } else if (d.tipo == "sport") {

                        costoSport = data.child("1").val();
                        console.log("Sport (1): ", costoBasico)

                    } else if (d.tipo == "vip") {

                        costoVip = data.child("1").val();
                        console.log("Vip (1): ", costoBasico)
...
function siguiente() {
    ...
    if (elemento == 1) {
        ...
        if (primera == true) {
            ...
            Swal.fire({
                title: '¿Estás seguro?',
                text: 'Confirma solo si estás seguro de que todos los datos son correctos',
                icon: 'warning',
