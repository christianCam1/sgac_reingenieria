                    ...
                    <div class="card card-outline card-primary">
                        ...
                        <div class="card-body" style="display: block;">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select id="tiempoSeleccion" class="form-control">
                                        <option id="0.5" value="0.5">30 Minutos</option>
                                        <option id="1" value="1">1 Hora</option>
                                        <option id="1.5" value="1.5">90 Minutos</option>
                                        <option id="2" value="2">2 Horas</option>
                                    </select>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select id="pagoSeleccion" class="form-control">
                                        <option id="tarjetadc" value="tarjetadc">Tarjeta de D/C</option>
                                        <option id="tic" value="tic">Transferencia Interbancaria (Conekta)</option>
                                        <option id="eop" value="eop">Efectivo Oxxo Pay</option>
                                        <option id="tdh" value="tdh">Transferencia directa (Humaniia)</option>
                                        <option id="Sin_pago" value="Sin pago">Sin pago</option>
                                        <option id="Descuento" value="Descuento">Descuento Caminandog</option>
                                    </select>

                                </div>

                                <div class="form-group col-md-6">
                                    <label for="paisPaseo" id="paisPaseoLabel"> Pais :</label>
                                    <input type="text" id="paisPaseo" class="form-control" disabled>

                                </div>

                                <div class="form-group col-md-6">
                                    <label for="tipoMoneda" id="tipoMonedaLabel"> Moneda :</label>
                                    <input type="text" id="tipoMoneda" class="form-control" disabled>
                            ...
                            <div class="row" id="rowCosto">
                                ...
                                <div class="col" id="country">Dos</div>
                                <div class="col-2"></div>
                                <div class="w-100"></div>
                                <div class="col-2"></div>
                                <div class="col">Tipo de moneda</div>
                                <div class="col" id="currencyCharge">Dos</div>
                                <div class="col-2"></div>
                                <div class="w-100"></div>
                                <div class="col-2"></div>
...
<script src="<?php echo $URL; ?>/app/controllers/paseos/pedirPaseo.js"></script>
