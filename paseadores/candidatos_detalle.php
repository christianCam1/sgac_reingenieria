                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <button type="button" class="btn btn-primary btn-sm btn-block"
                                                id="siguiente" onclick="ver_chat()"><i
                                                    class="fa-regular fa-floppy-disk"></i> Ir a Chat
                                            </button>
                                        </div>
                                    </div>
                                    <!-- /.card -->
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-header p-2">
                                            <ul class="nav nav-pills">
                                                ...
                                                <li class="nav-item"><a class="nav-link" href="#evaluacion"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="tab-content">
                                                <div class="active tab-pane" id="datos">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="card card-primary card-outline">
                                                                <div class="card-header">
                                                                    <h3 class="card-title">Experiencia laboral 1 de 3
                                                                    </h3>
                                                                    <div class="card-tools">
                                                                        <button type="button" class="btn btn-tool"
                                                                            data-card-widget="collapse"><i
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="medioEntero"
                                                                            id="medioEnteroLabel">¿Por que medio te
                                                                            enteraste de nosotros?</label>
                                                                        <select id="medioEntero" class="form-control">
                                                                            <option disabled selected value> -----
                                                                            </option>
                                                                            <option value="Instagram">Instagram</option>
                                                                            <option value="Facebook">Facebook</option>
                                                                            <option value="Nuestra página">Nuestra
                                                                                página</option>
                                                                            <option value="Por un familiar o conocido">
                                                                                Por un familiar o conocido</option>
                                                                            <option value="Por un anuncio impreso">Por
                                                                                un anuncio impreso</option>
                                                                            <option
                                                                                value="Por publicidad en camiones o transportes">
                                                                                Por publicidad en camiones o transportes
                                                                            </option>
                                                                            <option value="Otro medio">Otro medio
                                                                            </option>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select id="expectativaIngreso"
                                                                            ...
                                                                            <option value="Mas de $12,000">Mas de
                                                                                $12,000</option>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="planDatos" id="planDatosLabel">¿Cual
                                                                            es tu plan de datos mensual?</label>
                                                                        <select id="planDatos" class="form-control">
                                                                            <option disabled selected value> -----
                                                                            </option>
                                                                            <option value="De 0.5 GB a 1.4 GB"> De 0.5
                                                                                GB a 1.4 GB</option>
                                                                            <option value="De 1.5 GB a 2.4 GB">De 1.5 GB
                                                                                a 2.4 GB</option>
                                                                            <option value="De 2.5 GB a 5.0 GB">De 2.5 GB
                                                                                a 5.0 GB</option>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="card card-primary card-outline">
                                                                <div class="card-header">
                                                                    <h3 class="card-title">Experiencia laboral 2 de 3
                                                                    </h3>
                                                                    <div class="card-tools">
                                                                        <button type="button" class="btn btn-tool"
                                                                            data-card-widget="collapse"><i
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="card card-primary card-outline">
                                                                <div class="card-header">
                                                                    <h3 class="card-title">Experiencia laboral 3 de 3
                                                                    </h3>
                                                                    <div class="card-tools">
                                                                        <button type="button" class="btn btn-tool"
                                                                            data-card-widget="collapse"><i
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="card card-primary card-outline">
                                                                <div class="card-header">
                                                                    <h3 class="card-title" id="tituloTest">Test 1 de 1
                                                                    </h3>
                                                                    <div class="card-tools">
                                                                        <button type="button" class="btn btn-tool"
                                                                            data-card-widget="collapse"><i
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="form-group ">
                                                                        <label for="calif"
                                                                            id="califLabel">Calificación</label>
                                                                        <input type="text" class="form-control"
                                                                            id="calif" placeholder="" />
                                                                    </div>
                                                            ...
                                                            <div class="card card-primary card-outline">
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col">
                                                                            <img src="img/subir_foto.png" id="foto_acta"
                                                                                onclick="ver_imagen(this)"
                                                                                class="img_documentos"></img>
                                                                        </div>
                                                                    </div>
                                                ...
                                                <div class="tab-pane" id="evaluacion">
                                                                        ...
                                                                        <div class="col-sm-12">
                                                                            ...
                                                                            <div class="form-group clearfix">
                                                                                <div class="icheck-primary d-inline">
                                                                                    ...
                                                                                    <label for="datosPersonales">Datos
                                                                                        Personales</label>
                                                                                </div>
                                                                                <div class="icheck-primary d-inline">
                                                                                    <input type="checkbox"
                                                                                ...
                                                                                <div class="icheck-primary d-inline">
                                                                                    <input type="checkbox"
                                                                                        ...
                                                                                        onclick="check_click(this)">
                                                                                    <label
                                                                                        for="experiencia_laboral">Experiencia
                                                                                        Laboral</label>
                                                                                </div>
                                                                                <div class="icheck-primary d-inline">
                                                                                    <input type="checkbox"
                                                                                        id="test_confianza"
                                                                                        onclick="check_click(this)">
                                                                                    <label for="test_confianza">Test de
                                                                                        confianza</label>
                                                                                </div>
                                                                                <div class="icheck-primary d-inline">
                                                                                    <input type="checkbox"
                                                                                        ...
                                                                                        onclick="check_click(this)">
                                                                                    <label
                                                                                        for="documentos">Documentos</label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-sm-12">
                                                                            ...
                                                                            <div class="form-group clearfix">
                                                                                <div class="icheck-primary d-inline">
                                                                                    <input type="checkbox"
                                                                                        id="contacto_candidato"
                                                                                        onclick="check_click(this)">
                                                                                    <label
                                                                                        for="contacto_candidato">Contacto
                                                                                        con candidato</label>
                                                                                </div>
                                                                                <div class="icheck-primary d-inline">
                                                                                    <input type="checkbox"
                                                                                        id="validacion_contactos"
                                                                                        onclick="check_click(this)">
                                                                                    <label
                                                                                        for="validacion_contactos">Validación
                                                                                        de contactos</label>
                                                                                </div>
                                                                                <div class="icheck-primary d-inline">
                                                                                    <input type="checkbox"
                                                                            ...
                                                                            <div class="form-group clearfix">
                                                                                <div class="icheck-primary d-inline">
                                                                                    <input type="checkbox"
                                                                                        id="tecnica_paseo"
                                                                                        onclick="check_click(this)">
                                                                                    <label for="tecnica_paseo">Técnica
                                                                                        de paseo</label>
                                                                                </div>
                                                                                <div class="icheck-primary d-inline">
                                                                                    <input type="checkbox" id="uso_app"
                                                                                        onclick="check_click(this)">
                                                                                    <label for="uso_app">Uso de la
                                                                                        aplicación</label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                    ...
                                                    <button type="button" class="btn btn-primary btn-lg float-right"
                                                        id="siguiente" onclick="contratar_candidato()"><i
                                                            class="fa-regular fa-floppy-disk"></i> Contratar
                                                    </button>
                                                </div>
                                                <!-- /.tab-pane -->
                                            </div>
...
<script src="<?php echo $URL; ?>/app/controllers/paseadores/candidato_detalle.js"></script>
