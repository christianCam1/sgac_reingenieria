...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0">Chat de Paseador</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                                    ...
                                    <div class="card card-primary card-outline">
                                        <div class="card-body box-profile">
                                            ...
                                            <a class="btn btn-info btn-block" id="verinfo"
                                                onclick="verinformacioncandidato()"><b>Ver información del paseador</b></a>
...
<script src="<?php echo $URL; ?>/app/controllers/paseadores/chatPaseadoresCaminandog.js"></script>
